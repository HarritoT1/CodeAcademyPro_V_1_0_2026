    ...
    <main>
      <div class="pt-5 pb-4 text-center">
        ...
        <p class="fs-5 fw-lighter lh-sm">
          ...
          estas aceptando los términos y condiciones de <a class="element-animation" title="Terms and conditions"
            data-bs-toggle="modal" data-bs-target="#conditions">
            CodeAcademyPro
          </a>.
        </p>
      </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="p-3 text-justify" style="overflow-x: hidden;">
                ...
                <b class="text-uppercase" style="font-size: 1.1rem;">1. Aceptación de los términos:</b>
                <p class="fw-lighter" style="text-align: justify;">
                  Al registrarse o utilizar la plataforma CodeAcademyPro, el usuario acepta cumplir con los presentes
                  Términos y Condiciones. Si no está de acuerdo con ellos, deberá abstenerse de utilizar la plataforma.
                </p>

                <b class="text-uppercase" style="font-size: 1.1rem;">2. Descripción del servicio:</b>
                <p class="fw-lighter" style="text-align: justify;">
                  CodeAcademyPro es una plataforma educativa en línea orientada al aprendizaje de programación mediante
                  cursos estructurados en temas y subtemas. Los usuarios pueden acceder al contenido, inscribirse en
                ...
                <p class="fw-lighter" style="text-align: justify;">
                  Para utilizar ciertas funcionalidades, el usuario deberá crear una cuenta proporcionando información
                  válida. El usuario es responsable de mantener la confidencialidad de sus credenciales y del uso que se
                  haga de su cuenta.
                </p>

                <b class="text-uppercase" style="font-size: 1.1rem;">4. Uso adecuado de la plataforma:</b>
                <p class="fw-lighter" style="text-align: justify;">
                  El usuario se compromete a utilizar la plataforma únicamente con fines educativos y conforme a la ley.
                  Queda prohibido intentar acceder de manera no autorizada al sistema, interferir con su funcionamiento
                ...
                <p class="fw-lighter" style="text-align: justify;">
                  Todo el contenido disponible en la plataforma, incluyendo cursos, materiales, textos e imágenes,
                  pertenece a CodeAcademyPro o a sus respectivos autores y está protegido por las leyes de propiedad
                ...
                <p class="fw-lighter" style="text-align: justify;">
                  Los usuarios pueden inscribirse en los cursos disponibles en la plataforma para acceder a su contenido
                  y realizar seguimiento de su progreso.
                </p>

                <b class="text-uppercase" style="font-size: 1.1rem;">7. Seguimiento de progreso:</b>
                <p class="fw-lighter" style="text-align: justify;">
                  La plataforma registra el avance del usuario en los cursos mediante el seguimiento de los temas y
                  subtemas completados, con el objetivo de mostrar su progreso dentro del curso correspondiente.
                </p>
            ...
            <div class="modal-footer">
              <button type="button" class="btn element-animation py-2 px-3" data-bs-dismiss="modal">Aceptar</button>
            </div>
      ...
      <div class="modal fade" id="mail_confirm" tabindex="-1">
        <div class="modal-dialog modal-xl">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <h5 class="h5 my-0 text-justify fs-6 lh-base">Te hemos enviado un correo con un enlace a @correo, por
                favor da clic para confirmar
                tu correo y ser redirigido.</h5>
            </div>

            <div class="modal-footer">
              <a class="element-animation" onclick="cancelRegistration()" title="Cancel">Cancelar registro de cuenta</a>
            </div>
        ...
        <form id="create_user" action="" method="post" enctype="multipart/form-data"
          ...
          <div class="row g-3">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" required maxlength="255" class="form-control" id="fullname" name="fullname"
                placeholder="" value="" />
            ...
            <div class="col-sm-6">
              ...
              <input type="text" required maxlength="255" class="form-control" id="name" name="name" placeholder=""
                value="" />
              <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <input type="text" required min="8" maxlength="255" class="form-control" id="password" name="password"
                placeholder="" value="" />
            ...
            <div class="col-sm-6">
              ...
              <input type="text" required min="8" maxlength="255" class="form-control" id="confirm_password"
            ...
            <div class="col-12">
              <label for="email" class="form-label">Email <span class="text-danger fw-lighter">(debera confirmarse para
                  crear la cuenta)</span></label>
              <div class="input-group">
                <span class="input-group-text">@</span>
                <input type="email" maxlength="255" required class="form-control" id="email" name="email"
                  placeholder="@dominio" value="">
                <div class="invalid-feedback">
            ...
            <div class="col-sm-6">
              ...
              <select class="form-control form-select" id="rol_id" name="rol_id" aria-label="Default select example"
                required>
            ...
            <div class="col-sm-6">
              ...
              <input type="tel" maxlength="20" required pattern="^[0-9]{2}-[0-9]{4}-[0-9]{4}$" class="form-control"
                id="phone_number" name="phone_number" placeholder="55-8837-4683" value="" />
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              ...
              <input type="text" required class="form-control" id="home_address" name="home_address"
                placeholder="Calle Flores Jardines de Chalco EDOMEX C.P. 56607" value="" />
              <div class="invalid-feedback">
            ...
            <div class="col-12">
              <label for="description" class="form-label">Añade una descripción de ti mismo (para tu perfil)</label>
              <textarea rows="6" required class="form-control" id="description" name="description"
                placeholder="Escribe algo sobre ti..." aria-label="Notas"
            ...
            <div class="col-12 text-center mt-4">
              ...
              <br>
              <input type="file" id="avatar_url" name="avatar_url" accept="image/png, image/jpeg, image/webp, image/gif"
                class="form-control" onchange="previewImage(event, 'preview')" />
              <div class="invalid-feedback">
