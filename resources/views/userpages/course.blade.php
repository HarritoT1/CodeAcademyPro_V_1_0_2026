...
<body id="body">
    ...
    <div class="row" style="min-height: 100vh;">
      ...
      <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
        <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
          ...
          <a class="d-block fw-bold px-3 h2 text-body" style="font-size: 0.8rem; text-align: center !important;" target="_blank" title="ir" href="">@Curso PHP desde 0 paso a paso (fundamentos).
          </a>
          ...
          <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto overflow-x-hidden">
            <ul class="nav flex-column" style="font-size: 0.7rem !important;">
              <!-- li = Tema -->
              <li class="mb-2">
                <a class="element-animation w-100 px-3 text-body fw-bold" href="" title="ir" target="_self"
                  style="font-size: 0.7rem !important; text-align: justify;">Restricciones SQL</a>

                <button class="px-3 btn btn-toggle w-100 d-inline-flex align-items-center rounded border-0 collapsed"
                  style="font-size: 0.7rem !important; text-align: justify;" data-bs-toggle="collapse"
                ...
                <div class="collapse show px-3 px-md-2" id="collapse_1">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <!-- li = Subtema -->
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Primary key</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Foreing Key</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Unique</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Not Null</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Default</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Check</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li class="mb-2">
                <a class="element-animation w-100 px-3 text-body fw-bold" href="" title="ir" target="_self"
                  style="font-size: 0.7rem !important; text-align: justify;">Joins</a>
                ...
                <div class="collapse show px-3 px-md-2" id="collapse_2">
                  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <!-- li = Subtema -->
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Inner Join</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Left Join</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Right Join</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Full Outer Join</a>
                    </li>
                    <li>
                      <a href=""
                        class="w-100 link-body-emphasis d-inline-flex text-decoration-none rounded text-body element-animation"
                        title="ir" target="_self">Auto Join</a>
                    </li>
                  </ul>
                </div>
              </li>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        <div class="py-4">
          ...
          <div class="my-4">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb p-3 bg-body-tertiary rounded-3">
                <li class="breadcrumb-item"><a href="" target="_self" title="ir" class="element-animation p-0">@coursename</a></li>
                <li class="breadcrumb-item"><a href="" target="_self" title="ir" class="element-animation p-0">@tema</a></li>
                <li class="breadcrumb-item"><a href="" target="_self" title="ir" class="element-animation p-0">@subtema</a></li>
              </ol>
            </nav>
          </div>

          <h1 class="h2 fw-bold text-uppercase" style="color: rgb(197, 5, 255);" id="topic_title">@Check</h1>

          <hr class="my-4">

          <div class="text-break lh-base" style="text-align: justify; font-size: 1.1rem !important;" id="topic_content">
          ...
          <button class="d-block element-animation px-5 py-2 mb-5" type="button" style="margin-left: auto; outline: black 3px solid;" title="Registrar" onclick="registerAdvance(event, 'id', 'subtopic')"> 
  ...
  <div id="succes_div" class="animation-show position-fixed fw-bold btn btn-outline-success text-center" style="top: 5rem; right: 3rem; width: 15rem; border-radius: 15px 15px 0px 15px; background-color: rgb(2, 70, 2);">
    AVANCE REGISTRADO EXITOSAMENTE.
  </div>

  <div id="error_div" class="animation-show position-fixed fw-bold btn btn-outline-danger text-center" style="top: 5rem; right: 3rem; width: 15rem; border-radius: 15px 15px 0px 15px; background-color: rgb(110, 25, 25);">
